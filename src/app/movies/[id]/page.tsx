...
const MoviePage = async () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      {/* Header Section */}
      <div className="mb-8 border-b-2 pb-2"></div>
      ...
      >
        <AccordionItem value="item-1">
          <AccordionTrigger>Kelapa Gading XIX</AccordionTrigger>
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger>Pondok Indah 1 XIX</AccordionTrigger>
          <AccordionContent className="flex gap-4 text-balance">
            <Button asChild>
              <Link href="#">4.30</Link>
            </Button>
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger>Gandaria City XIX</AccordionTrigger>
          <AccordionContent className="flex gap-4 text-balance">
            <Button asChild>
              <Link href="#">4.30</Link>
            </Button>
